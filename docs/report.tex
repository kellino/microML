...
be fair to say the GHC has largely become the `de facto' Haskell implementation, moving it more in
the direction of Python, which is defined by CPython, rather than a formal document description.
