    ...
    \begin{threeparttable}
       \caption{Project Requirements}
        \begin{tabular}{g l r}
            ...
            \hline
            15 & Editor support for coding& C \\
...
\begin{figure}
    \begin{itemize}
        \item Haskell: module COMPGC16 provided a basis upon which to build, but did not
            ...
            functional language.
        \item Automata Theory: module COMPGC04 was an introduction to systems infrastructure. The
        ...
        \item Lambda Calculus:  beyond a brief introduction to the simple untyped lambda
            calculus, the author had no other experience whatsoever with the area of computational
        ...
        \item Type Theory: the author was very interested in the potential of type theory to make
            ...
            theoretical fashion.
        \item Language Design: microML offered the opportunity for the author to develop a language
    ...
    \begin{threeparttable}
       \caption{Project Achievements}
        \begin{tabular}{g l c c}
            ...
            \hline
            15 & Editor support for coding & C & \checkmark\\
