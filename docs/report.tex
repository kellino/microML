...
deliberately falsely attributed, but it is itself a close paraphrase from~\cite{opac-b1078351} p.138.} 
\end{flushright}
...
\begin{table}
    \begin{tabu}{|>{\columncolor[gray]{0.9}}p{3.5cm}| p{10cm} |}
        \hline
        ...
        \hline
        Entry Conditions & not sure yet \\
        \hline
        Exit Conditions & not sure yet \\
        \hline
    \end{tabu}
\end{table}
...
\begin{table}
    ...
    {\begin{tabu}{l | l |}
        \hline
        Use Case & Student Use Case \\
        Participating Actors & Student \\
        Flow of Events & stuff here \\
        Alternative Flows & stuff here \\
        Entry Conditions & not sure yet \\
        Exit Conditions & not sure yet \\
    \end{tabu}}
\end{table}
