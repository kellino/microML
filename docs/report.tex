...
files. A separate parser was written for a small subset of markdown and pretty printing facilities
...
GHC\. This does unfortunately limit the portability of microML to a certain extent, but it would also
be reasonable to say the GHC has largely become the `de facto' Haskell implementation, moving the
